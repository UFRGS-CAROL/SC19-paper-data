...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: mnist_1, and set properties
  set mnist_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_1 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_1/s_axi_AXILiteS]

  # Create instance: mnist_2, and set properties
  set mnist_2 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_2 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_2/s_axi_AXILiteS]

  # Create instance: mnist_3, and set properties
  set mnist_3 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_3 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_3/s_axi_AXILiteS]

  # Create instance: mnist_4, and set properties
  set mnist_4 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_4 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_4/s_axi_AXILiteS]

  # Create instance: mnist_5, and set properties
  set mnist_5 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_5 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_5/s_axi_AXILiteS]

  # Create instance: mnist_6, and set properties
  set mnist_6 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_6 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_6/s_axi_AXILiteS]

  # Create instance: mnist_7, and set properties
  set mnist_7 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_7 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_7/s_axi_AXILiteS]

  # Create instance: mnist_8, and set properties
  set mnist_8 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_8 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_8/s_axi_AXILiteS]

  # Create instance: mnist_9, and set properties
  set mnist_9 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist:1.0 mnist_9 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /mnist_9/s_axi_AXILiteS]
...
CONFIG.NUM_MI {11} \
  ...
  # Create instance: tmr_control_dut_0, and set properties
  set tmr_control_dut_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:tmr_control_dut:1.0 tmr_control_dut_0 ]
  set_property -dict [ list \
CONFIG.BYTES_TO_UART {44} \
 ] $tmr_control_dut_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mnist_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins mnist_1/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins mnist_2/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins mnist_3/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins mnist_4/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins mnist_5/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins mnist_6/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins mnist_7/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins mnist_8/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins mnist_9/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M10_AXI]

  # Create port connections
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins tmr_control_dut_0/mem0_doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins mnist_0/ap_clk] [get_bd_pins mnist_1/ap_clk] [get_bd_pins mnist_2/ap_clk] [get_bd_pins mnist_3/ap_clk] [get_bd_pins mnist_4/ap_clk] [get_bd_pins mnist_5/ap_clk] [get_bd_pins mnist_6/ap_clk] [get_bd_pins mnist_7/ap_clk] [get_bd_pins mnist_8/ap_clk] [get_bd_pins mnist_9/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins tmr_control_dut_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins mnist_0/ap_rst_n] [get_bd_pins mnist_1/ap_rst_n] [get_bd_pins mnist_2/ap_rst_n] [get_bd_pins mnist_3/ap_rst_n] [get_bd_pins mnist_4/ap_rst_n] [get_bd_pins mnist_5/ap_rst_n] [get_bd_pins mnist_6/ap_rst_n] [get_bd_pins mnist_7/ap_rst_n] [get_bd_pins mnist_8/ap_rst_n] [get_bd_pins mnist_9/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins tmr_control_dut_0/rst]
  connect_bd_net -net rx_1 [get_bd_ports rx] [get_bd_pins tmr_control_dut_0/rx]
  connect_bd_net -net tmr_control_dut_0_mem0_addrb [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins tmr_control_dut_0/mem0_addrb]
  connect_bd_net -net tmr_control_dut_0_mem0_dinb [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins tmr_control_dut_0/mem0_dinb]
  connect_bd_net -net tmr_control_dut_0_mem0_enb [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins tmr_control_dut_0/mem0_enb]
  connect_bd_net -net tmr_control_dut_0_mem0_web [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins tmr_control_dut_0/mem0_web]
  connect_bd_net -net tmr_control_dut_0_tx [get_bd_ports tx] [get_bd_pins tmr_control_dut_0/tx]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_0/s_axi_AXILiteS/Reg] SEG_mnist_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_1/s_axi_AXILiteS/Reg] SEG_mnist_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_2/s_axi_AXILiteS/Reg] SEG_mnist_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_3/s_axi_AXILiteS/Reg] SEG_mnist_3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_4/s_axi_AXILiteS/Reg] SEG_mnist_4_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_5/s_axi_AXILiteS/Reg] SEG_mnist_5_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_6/s_axi_AXILiteS/Reg] SEG_mnist_6_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_7/s_axi_AXILiteS/Reg] SEG_mnist_7_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_8/s_axi_AXILiteS/Reg] SEG_mnist_8_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C90000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mnist_9/s_axi_AXILiteS/Reg] SEG_mnist_9_Reg
...
preplace port tx -pg 1 -y 40 -defaultsOSRD
preplace port rx -pg 1 -y 110 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 590 -defaultsOSRD
preplace inst mnist_4 -pg 1 -lvl 3 -y 900 -defaultsOSRD
preplace inst mnist_5 -pg 1 -lvl 3 -y 1020 -defaultsOSRD
preplace inst mnist_6 -pg 1 -lvl 3 -y 1140 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -y 160 -defaultsOSRD
preplace inst mnist_7 -pg 1 -lvl 3 -y 1260 -defaultsOSRD
preplace inst mnist_8 -pg 1 -lvl 3 -y 1380 -defaultsOSRD
preplace inst mnist_9 -pg 1 -lvl 3 -y 1500 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 920 -defaultsOSRD
preplace inst mnist_0 -pg 1 -lvl 3 -y 380 -defaultsOSRD
preplace inst mnist_1 -pg 1 -lvl 3 -y 500 -defaultsOSRD
preplace inst tmr_control_dut_0 -pg 1 -lvl 3 -y 100 -defaultsOSRD
preplace inst mnist_2 -pg 1 -lvl 3 -y 660 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -y 260 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 430 -defaultsOSRD
preplace inst mnist_3 -pg 1 -lvl 3 -y 780 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 650 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 790
preplace netloc processing_system7_0_DDR 1 1 4 NJ 570 NJ 570 NJ 570 NJ
preplace netloc tmr_control_dut_0_mem0_web 1 3 1 1150
preplace netloc rx_1 1 0 3 NJ 110 NJ 110 NJ
preplace netloc ps7_0_axi_periph_M09_AXI 1 2 1 770
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 1180
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 450
preplace netloc tmr_control_dut_0_tx 1 3 2 1190J 40 NJ
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 470 810
preplace netloc ps7_0_axi_periph_M07_AXI 1 2 1 820
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 520 430
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 750
preplace netloc tmr_control_dut_0_mem0_addrb 1 3 1 1190
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 760
preplace netloc ps7_0_axi_periph_M08_AXI 1 2 1 790
preplace netloc ps7_0_axi_periph_M06_AXI 1 2 1 830
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 590 NJ 590 NJ 590 NJ
preplace netloc tmr_control_dut_0_mem0_enb 1 3 1 1160
preplace netloc ps7_0_axi_periph_M05_AXI 1 2 1 790
preplace netloc ps7_0_axi_periph_M04_AXI 1 2 1 770
preplace netloc tmr_control_dut_0_mem0_dinb 1 3 1 1170
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 20 260 470 260 800 10 1200
preplace netloc ps7_0_axi_periph_M10_AXI 1 2 1 750
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 780
preplace netloc axi_bram_ctrl_0_bram_doutb 1 2 2 830 190 NJ
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 460
levelinfo -pg 1 0 230 610 990 1320 1450 -top 0 -bot 1570
",
}
