...
HD_PWD='/home/fplibano/vivado/mnist_HLS_R/mnist_HLS_R.runs/design_1_tmr_control_dut_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_tmr_control_dut_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_tmr_control_dut_0_0.tcl
